 ...
 * it under the terms of the GNU General Public License as publishenextiond by
...
//1*200*32 = 6400 step/vong ->
// 16384/2 xung 1 vong ->8192 xung 1 vong
#define STEPS_PER_DEGREE ((10000)/ 360.0)
#define Z_STEPS_PER_MM   (1.0 * 200 * 64 * 5 / 15   ) //15 LÀ (1/3)/5
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 30000, 30000, 10000, 10000 }
...
#define MANUAL_X_HOME_POS 590
#define MANUAL_Y_HOME_POS 0
#define MANUAL_Z_HOME_POS 0
#define mWorkGoHome
#if ENABLED(mWorkGoHome)
  #define THETA_ANGLE_AT_HOME 10
...
#define ST7920_DELAY_3 DELAY_NS(100) //DELAY_NS(0)
//
...
// Where to find : ![Link](https://www.aliexpress.com/item/4000345255731.html)
