...
#define STRING_CONFIG_H_AUTHOR "(mWork, default config)" // Who made the changes.
...
#define X_MIN_POS -660
#define Y_MIN_POS -660
#define Z_MIN_POS 0
#define X_MAX_POS 660
#define Y_MAX_POS 660
#define Z_MAX_POS 8000
